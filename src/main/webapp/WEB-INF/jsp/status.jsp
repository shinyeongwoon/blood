		...
		<div id="status">
			<div id="wrap">
				<div id="upper"> 
					<p>현황판</p>
					<ul  class="after">
					<li class="total"><a href="#" class="title">총 헌혈증 수</a><hr><a href="#" class="cnt">${allCardCnt}</a></li>
					<li class="agree"><a href="#" class="title">대출가능 헌혈증 수</a><hr><a href="#" class="cnt">${possCnt}</a></li>
					<li class="loan"><a href="#" class="title">대출 헌혈증 수</a><hr><a href="#" class="cnt">${loanCnt}</a></li>
				</ul>
				</div>
				...
				<div id="bottom">
					<div id="myLoanImpo">
						이름 : ${sessionScope.loginedUser.name}<br><br>
						헌혈증 대출 수 : ${applicationScope.userLoanCnt}<br><br>
						헌혈증 상환 수 : ${applicationScope.userLoanbackCnt}<br><br>
						잔여 상환 기간 : <c:choose>
						
										<c:when test="${applicationScope.userLoanDate eq null}">
										-
										</c:when>
										
										<c:otherwise>
										${applicationScope.userLoanDate}<br><br>
										</c:otherwise>
					...
					<c:choose>
						<c:when test="${applicationScope.userLoanCnt != 0}">
							<form action="http://localhost:8099/card/loanback">
								<button id="loanbackbtn">상환하러 가기</button>
							</form>
						</c:when>
						<c:otherwise>
